...
BEGIN
    ...
    BEGIN TRY
        ...
        WHERE flag_last = 1; -- Selects most recent records per customer.
        ...
        SELECT
            ...
            CASE
                ...
                WHEN TRIM((REPLACE(REPLACE(cntry, CHAR(13), ''), CHAR(10), ''))) = '' OR (REPLACE(REPLACE(cntry, CHAR(13), ''), CHAR(10), '')) IS NULL THEN 'n/a'
        ...
        SET @start_time = GETDATE();
        PRINT '>> Truncating Table: silver.erp_px_cat_g12';
        TRUNCATE TABLE silver.erp_px_cat_g12;
        PRINT '>> Inserting Data Into: silver.erp_px_cat_g12';
        INSERT INTO silver.erp_px_cat_g12(
            id,
            cat,
            subcat,
            maintenance
